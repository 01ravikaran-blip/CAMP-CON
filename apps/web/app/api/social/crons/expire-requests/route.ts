...
// Removed prisma/client import to prevent Vercel type error on missing generated model
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    await prisma.$transaction(
      expiredRequests.map((req: { id: string; energySpent: number; requesterId: string }) => {
